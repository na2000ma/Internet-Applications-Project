...
import {FSDocument, FSDocumentElement} from "@organizo/components/fullscreen/fullscreen.types";

@Component({
  selector: 'organizo-fullscreen',
  templateUrl: './fullscreen.component.html',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  exportAs: 'organizoFullscreen',
  standalone: true,
  imports: [MatButtonModule, MatTooltipModule, NgTemplateOutlet, MatIconModule],
})
export class OrganizoFullscreenComponent implements OnInit {
