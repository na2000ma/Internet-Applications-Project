...
export class OrganizoVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy {
  ...
  @HostBinding('class') get classList(): any {
    /* eslint-disable @typescript-eslint/naming-convention */
    return {
      'organizo-vertical-navigation-item-collapsed': this.isCollapsed,
      'organizo-vertical-navigation-item-expanded': this.isExpanded,
    };
    /* eslint-enable @typescript-eslint/naming-convention */
  }
  ...
  ngOnInit(): void {
    ...
    this._organizoVerticalNavigationComponent.onCollapsableItemCollapsed
    ...
    if (this.autoCollapse) {
      this._organizoVerticalNavigationComponent.onCollapsableItemExpanded
        .pipe(takeUntil(this._unsubscribeAll))
  ...
  collapse(): void {
    ...
    this._organizoVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
  }
  ...
  expand(): void {
    ...
    // Execute the observable
    this._organizoVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
  }
   ...
   * @private
   */
  private _isChildrenOf(parent: OrganizoNavigationItem, item: OrganizoNavigationItem): boolean {
