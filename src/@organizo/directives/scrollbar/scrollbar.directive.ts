...
import {ScrollbarGeometry, ScrollbarPosition} from "@organizo/directives/scrollbar/scrollbar.types";

/**
 * Wrapper directive for the Perfect Scrollbar: https://github.com/mdbootstrap/perfect-scrollbar
 */
@Directive({
  selector: '[organizoScrollbar]',
  exportAs: 'organizoScrollbar',
  standalone: true,
})
export class OrganizoScrollbarDirective implements OnChanges, OnInit, OnDestroy {
  /* eslint-disable @typescript-eslint/naming-convention */
  static ngAcceptInputType_organizoScrollbar: BooleanInput;
  /* eslint-enable @typescript-eslint/naming-convention */

  @Input() organizoScrollbar: boolean = true;
  @Input() organizoScrollbarOptions: PerfectScrollbar.Options;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    // Enabled
    if ('organizoScrollbar' in changes) {
      // Interpret empty string as 'true'
      this.organizoScrollbar = coerceBooleanProperty(changes.organizoScrollbar.currentValue);

      // If enabled, init the directive
      if (this.organizoScrollbar) {
        this._init();
      }
    ...
    // Scrollbar options
    if ('organizoScrollbarOptions' in changes) {
      // Merge the options
      this._options = merge({}, this._options, changes.organizoScrollbarOptions.currentValue);
